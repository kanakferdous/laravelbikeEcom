...
<div id="content-container">
    ...
    <div class="pageheader">
        <h3><i class="fa fa-home"></i> All Social URLs </h3>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
<div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Add, Remove &amp; Update Social URLs</h3>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6 text-xs-center">
                        <div class="form-group">
                            <a href="{{route('social.create')}}" id="demo-btn-addrow" class="btn btn-primary">Add New Social URL</a>
                        </div>
                    </div>
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle default no-paging footable-loaded footable" data-page-size="7">
                <thead>
                    <tr>
                        ...
                        <th class="footable-visible footable-sortable">Social Name<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Social URL<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Social Create Date<span class="footable-sort-indicator"></span></th>
                ...
                <tbody>
                    ...
                    <tr class="footable-even" style="display: table-row;">
                        ...
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$social->name}}</td>
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$social->link}}</td>
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$social->created_at}}</td>
                        <td class="footable-visible footable-last-column">
                            <form action="{{'/social/'. $social->id}}" method="POST">
                                {{csrf_field()}}
                                {{method_field('DELETE')}}
                                <button class= "btn btn-danger" type="submit"><i class="fa fa-trash"></i></button>
                                <a href="{{'/social/'.$social-> id.'/edit'}}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                            </form>
                        </td>
                    </tr>
                    @php
