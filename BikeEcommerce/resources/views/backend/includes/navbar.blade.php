    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-content clearfix">
                        ...
                        <div class="nano scrollable">
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left"> <img src="{{asset('backend/img/av2.png')}}" alt="Profile Picture" class="img-circle img-sm"> </div>
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left"> <img src="{{asset('backend/img/av4.png')}}" alt="Profile Picture" class="img-circle img-sm"> </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left"> <img src="{{asset('backend/img/av3.png')}}" alt="Profile Picture" class="img-circle img-sm"> </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a href="#" class="media">
                                            <div class="media-left"> <img src="{{asset('backend/img/av6.png')}}" alt="Profile Picture" class="img-circle img-sm"> </div>
                                            <div class="media-body">
            ...
            <ul class="nav navbar-top-links pull-right">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <li class="dropdown">
                    <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown"> <span class="lang-selected"> <img class="lang-flag" src="{{asset('backend/img/flags/united-kingdom.png')}}" alt="English"> <span class="lang-id">EN</span> <span class="lang-name">English</span> </span>
                    </a>
                    <!--Language selector menu-->
                    <ul class="head-list dropdown-menu with-arrow">
                        <li>
                            <!--English-->
                            <a href="#" class="active"> <img class="lang-flag" src="{{asset('backend/img/flags/united-kingdom.png')}}" alt="English"> <span class="lang-id">EN</span> <span class="lang-name">English</span> </a>
                        </li>
                        <li>
                            <!--France-->
                            <a href="#"> <img class="lang-flag" src="{{asset('backend/img/flags/france.png')}}" alt="France"> <span class="lang-id">FR</span> <span class="lang-name">Fran&ccedil;ais</span> </a>
                        </li>
                        <li>
                            <!--Germany-->
                            <a href="#"> <img class="lang-flag" src="{{asset('backend/img/flags/germany.png')}}" alt="Germany"> <span class="lang-id">DE</span> <span class="lang-name">Deutsch</span> </a>
                        </li>
                        <li>
                            <!--Italy-->
                            <a href="#"> <img class="lang-flag" src="{{asset('backend/img/flags/italy.png')}}" alt="Italy"> <span class="lang-id">IT</span> <span class="lang-name">Italiano</span> </a>
                        </li>
                        <li>
                            <!--Spain-->
                            <a href="#"> <img class="lang-flag" src="{{asset('backend/img/flags/spain.png')}}" alt="Spain"> <span class="lang-id">ES</span> <span class="lang-name">Espa&ntilde;ol</span> </a>
                        </li>
                    </ul>
                </li>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                        <span class="pull-right"> <img class="img-circle img-user media-object" src="{{asset('backend/img/av1.png')}}" alt="Profile Picture"> </span>
