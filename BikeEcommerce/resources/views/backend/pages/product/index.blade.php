...
<div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Add, Remove &amp; Update Products</h3>
        </div>
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle default no-paging footable-loaded footable" data-page-size="7">
                <thead>
                    <tr>
                        ...
                        <th class="footable-visible footable-sortable">Product Name<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Product Price<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Product Offer Price<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Product Quantity<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">product Create Date<span class="footable-sort-indicator"></span></th>
                ...
                <tbody>
                    ...
                    <tr class="footable-even" style="display: table-row;">
                        ...
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$product->name}}</td>
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$product->price}}</td>
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$product->offerprice}}</td>
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$product->quantity}}</td>
                        <td class="footable-visible" style="font-weight: bold; font-size: 16px;">{{$product->created_at}}</td>
