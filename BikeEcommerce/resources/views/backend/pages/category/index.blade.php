...
<div id="content-container">
    ...
    <div class="pageheader">
        <h3><i class="fa fa-home"></i> All Categorys </h3>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
<div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Add, Remove &amp; Update Categories</h3>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6 text-xs-center">
                        <div class="form-group">
                            <a href="{{route('category.create')}}" id="demo-btn-addrow" class="btn btn-primary">Add New Category</a>
                        </div>
                    </div>
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle default no-paging footable-loaded footable" data-page-size="7">
                <thead>
                    <tr>
                        ...
                        <th class="footable-visible footable-sortable">Category Name<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Category Description<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Category Image<span class="footable-sort-indicator"></span></th>
                        <th class="footable-visible footable-sortable">Parent ID<span class="footable-sort-indicator"></span></th>
                        <th data-hide="phone, tablet" class="footable-visible footable-sortable">Category Create Date<span class="footable-sort-indicator"></span></th>
                ...
                <tbody>
                    ...
                    <tr class="footable-even" style="display: table-row;">
                        ...
                        <td class="footable-visible"><img width="100px" src="{{ URL::asset('backend/img/category/'.$category->image) }}" style="transform: translate(50%, 0%);"></td>
                        ...
                        <td class="footable-visible footable-last-column">
                            <form action="{{'/category/'. $category->id}}" method="POST">
                                ...
                                <a href="{{'/category/'.$category-> id.'/edit'}}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                            </form>
                        </td>
                    </tr>
                    @php
